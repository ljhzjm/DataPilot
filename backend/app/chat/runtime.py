...
def _agent_system_prompt() -> str:
    return (
        ...
        "需要 Python 清洗、建模或导出文件时使用 run_python，"
        "并通过 datasets 参数列出所需表名；"
        "代码中只能从 /data/<table_name>/data.parquet 读取数据，"
        "并把 .csv、.json 或 .png 结果写入 /workspace/outputs。"
        "不得写入 /workspace 之外的位置。"
